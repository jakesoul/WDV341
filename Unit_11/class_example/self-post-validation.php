        ...
        <div id="form-content">
            ...
            <form name="form1" id="form-1" method="post" action="self-post-validation.php">
                <p>
                    ...
                    <input type="text" name="monkey_name" id="monkey-name" value="">
                </p>
                <p>
                ...
                <p>
                    ...
                    <input type="color" value="#C86D5C" name="color_hair" id="color-hair" /><br>
                    <label for="color-skin">Skin Color:</label>
                    <input type="color" value="#FBC4AC" name="color_skin" id="color-skin" /><br>
                    <label for="color-clothes">Clothes Color:</label>
                    <input type="color" value="#F2C42C" name="color_clothes" id="color-clothes" /><br>
                    <label for="color-boots">Boots Color:</label>
                    <input type="color" value="#3A484A" name="color_boots" id="color-boots" />
                </p>
                <p>
